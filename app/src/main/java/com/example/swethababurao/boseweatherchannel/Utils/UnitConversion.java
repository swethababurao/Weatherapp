package com.example.swethababurao.boseweatherchannel.Utils;
...
public class UnitConversion {
    public static float convertTemperature(float temperature, SharedPreferences sp) {
        if (sp.getString("unit", "°C").equals("°C")) {
            return UnitConversion.kelvinToCelsius(temperature);
        } else if (sp.getString("unit", "°C").equals("°F")) {
            return UnitConversion.kelvinToFahrenheit(temperature);
        } else {
            return temperature;
        }
    }
    ...
    public static float convertPressure(float pressure, String pressureUnit) {
        if (pressureUnit.equals("kPa")) {
            return pressure / 10;
        } else if (pressureUnit.equals("mm Hg")) {
            return (float) (pressure * 0.750061561303);
        } else if (pressureUnit.equals("in Hg")) {
    ...
    public static double convertWind(double wind, String windSpeed) {
        if (windSpeed.equals("kph")) {
            return wind * 3.6;
        }
        else if (windSpeed.equals("mph")) {
            return wind * 2.23693629205;
        }
        else if (windSpeed.equals("kn")) {
            return wind * 1.943844;
        }
        else if (windSpeed.equals("bft")) {
            if(wind < 0.3) {
                return 0; // Calm
            }
            else if (wind < 1.5) {
